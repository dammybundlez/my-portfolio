...
const cards = [
  ...
  },
  {
    ...
    image: '/library.png',
    position: 'lg:top-[46%] top-[67%] left-[11%] md:top-[50%] lg:left-[8%] md:w-72 lg:w-[30%] w-[80%]',
    rotate: 'lg:rotate-2',
  ...
  },
  {
    ...
    image: '/tracker.png',
    position: 'lg:top-[14%] lg:left-[40%] top-[46.5%] md:w-64 w-[80%] md:left-[56%] md:top-[24.5%] left-[11%]',
